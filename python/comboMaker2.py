...
#
# This func write best of the combos in this
#  iteration to a output file
###########################################################
def recordBestCombos(combos, heuristics):
    file2 = open("Outputs\\bestCombos.txt", 'a')
    print('Highest heuristic is ', heuristics[0])
